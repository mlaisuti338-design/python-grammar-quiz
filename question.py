questions = [
    ...
    },
    {
        ...
        "code": "_____ x > 5:",
        "answer": "if",
        "hints": ["条件が真のときに実行", "else とセットで使うこともある"],
    ...
    },
    {
        ...
        "code": "s = 'HELLO'\ns._____()",
        "answer": "lower",
        "hints": ["文字列を小文字に変換", "upper の逆"],
        "explanation": "lower() メソッドは文字列を小文字に変換します。"
    },
    {
        "id": 13,
        "question": "リスト nums の先頭要素を取り出すメソッドは？",
        "code": "first = nums.pop(0)",
        "answer": "pop",
        "hints": ["最後の要素ではない", "pop() は引数にインデックスを指定できる"],
    ...
    },
    {
        ...
        "code": "nums._____('a')",
        "answer": "remove",
        "hints": ["値を指定して削除", "pop と違ってインデックス不要"],
    ...
    },
    {
        ...
        "code": "dic._____({'b':2})",
        "answer": "update",
        "hints": ["複数要素をまとめて追加可能", "既存キーは上書きされる"],
    ...
    },
    {
        ...
        "code": "if x > 5:\n    print(x)\n_____:\n    print('小さい')",
        "answer": "else",
        "hints": ["if の後に続く", "条件が False のときに実行"],
    ...
    },
    {
        ...
        "code": "'''これは\n複数行コメントです'''",
        "answer": "",
        "hints": ["Pythonでは文字列として扱う", "三連引用符を使う"],
    ...
    },
    {
        ...
        "code": "s = _____(123)",
        "answer": "str",
        "hints": ["数値を文字列に変換", "printと組み合わせてよく使う"],
    ...
    },
    {
        ...
        "code": "s = 'a-b-c'\ns._____('-', '/')",
        "answer": "replace",
        "hints": ["古い文字を新しい文字に置き換える", "文字列の変換に便利"],
